...
import { NitroConfig, Nitro } from 'nitropack';
...
interface NuxtConfig extends DeepPartial<ConfigSchema> {
    [key: string]: any;
}
...
/** @deprecated use RuntimeConfig interface */
interface PrivateRuntimeConfig extends PublicRuntimeConfig {
}
declare type LegacyRuntimeConfig = PublicRuntimeConfig & Partial<PrivateRuntimeConfig>;
interface RuntimeConfig extends LegacyRuntimeConfig, RuntimeConfigNamespace {
